...
def test_ew_source_magnitude():
    ...
    eps_ac = mp.get("ac_interface_width", 5e-07)
    M_ac = mp.get("ac_mobility", 1e-10)
    ...
    assert 0.0001 < ew_at_surface < 100, f"EW source magnitude {ew_at_surface:.4e} out of reasonable range [1e-4, 1e2]"
